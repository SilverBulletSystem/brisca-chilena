...
## Contexto
Panel interno para monitoreo, alarmas y correlacion con records.

## Objetivo
Definir el modulo App Panel con enfoque DDD, integracion con el ecosistema y reglas de calidad.
