...
## Contexto
Autoapagado de features ante errores repetidos y escalamiento al panel.

## Objetivo
Definir el modulo Resilience Toggles con enfoque DDD, integracion con el ecosistema y reglas de calidad.
