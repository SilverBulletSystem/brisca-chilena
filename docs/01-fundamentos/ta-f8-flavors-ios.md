...
## Rama
- Crear desde `main`: `feat/ht-f8-flavors-ios`.
...
**Titulo sugerido:** `docs(ht-f8): spike esquemas ios (#F8)`

**Incluye:**
- Actualizacion de `docs/01-fundamentos/ta-f8-flavors-ios.md` (este documento).
