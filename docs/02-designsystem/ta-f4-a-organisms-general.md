...
## Rama
- `feat/ht-ds-f4-a-organisms-general`
...
**Titulo sugerido:** `docs(ds-f4a): bitacora organismos generales (#2)`

**Incluye:**
- Actualización de `docs/02-designsystem/ta-f4-a-organisms-general.md`.
