...
## Contexto
Partidas locales sin internet con roles host/cliente y sincronizacion.

## Objetivo
Definir el modulo Bluetooth con enfoque DDD, integracion con el ecosistema y reglas de calidad.
