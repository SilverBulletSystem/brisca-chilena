...
## Contexto
Estandar de tagging y captura de eventos transversal al DS, con providers externos y monitoreo local.

## Objetivo
Definir el modulo Analytics con enfoque DDD, integracion con el ecosistema y reglas de calidad.
