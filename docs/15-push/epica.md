...
## Contexto
Soporte de push con permisos, tokens y routing por deeplinks para promociones propias.

## Objetivo
Definir el modulo Notificaciones Push con enfoque DDD, integracion con el ecosistema y reglas de calidad.
